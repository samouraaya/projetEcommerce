 ...
 */
class Category extends \BackBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'BackBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'BackBundle\\Entity\\Category' . "\0" . 'description', '' . "\0" . 'BackBundle\\Entity\\Category' . "\0" . 'tickets'];
        }
     ...
     * {@inheritDoc}
     */
    public function addTicket(\BackBundle\Entity\Tickets $ticket)
    {
     ...
     * {@inheritDoc}
     */
    public function removeTicket(\BackBundle\Entity\Tickets $ticket)
    {
