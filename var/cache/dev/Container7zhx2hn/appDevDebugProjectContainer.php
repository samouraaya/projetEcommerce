...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            'fontbundle\\controller\\defaultcontroller' => 'FontBundle\\Controller\\DefaultController',
            'fontbundle\\fontbundle' => 'FontBundle\\FontBundle',
            'fontbundle\\service\\messagegenerator' => 'FontBundle\\service\\MessageGenerator',
        ...
        $this->fileMap = array(
            'FontBundle\\Controller\\DefaultController' => 'getDefaultControllerService.php',
            'FontBundle\\FontBundle' => 'getFontBundleService.php',
            'FontBundle\\service\\MessageGenerator' => 'getMessageGeneratorService.php',
            'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController' => 'getRedirectControllerService.php',
            'Symfony\\Bundle\\FrameworkBundle\\Controller\\TemplateController' => 'getTemplateControllerService.php',
            'User.form.registration' => 'getUser_Form_RegistrationService.php',
            ...
            'user.redirect_after_registration_subscriber' => 'getUser_RedirectAfterRegistrationSubscriberService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('JbjVHx7jjm', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->getTwig_LoaderService()) && false ?: '_'}, array('debug' => true, 'strict_variables' => true, 'cache' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => $this->parameters['twig.form.resources'], 'autoescape' => 'name', 'charset' => 'UTF-8', 'default_path' => ($this->targetDirs[3].'/templates'), 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b4w41cu28B', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ky55Oewii4', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1rqrpbsofP', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('fos_user.registration.success', array(0 => function () {
            return ${($_ = isset($this->services['user.redirect_after_registration_subscriber']) ? $this->services['user.redirect_after_registration_subscriber'] : $this->load('getUser_RedirectAfterRegistrationSubscriberService.php')) && false ?: '_'};
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1edd799927552a4a38bd7e7065633af297367025')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/BackBundle/Resources/views'), '!Back');
        $instance->addPath(($this->targetDirs[3].'/src/FontBundle/Resources/views'), 'Font');
        $instance->addPath(($this->targetDirs[3].'/src/FontBundle/Resources/views'), '!Font');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1edd799927552a4a38bd7e7065633af297367025');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'FontBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/FontBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FontBundle' => 'FontBundle\\FontBundle',
            ...
            'secret' => '1edd799927552a4a38bd7e7065633af297367025',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '1edd799927552a4a38bd7e7065633af297367025',
            ...
            'fos_user.model.user.class' => 'BackBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'UserBundle\\Form\\RegistrationFormType',
